...
const Wordmark = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      width: 1,
      height: 26,
      background: tone === "light" ? "rgba(255,255,255,0.25)" : "rgba(26,20,16,0.2)"
    }
  }), /*#__PURE__*/React.createElement("div", {
    style: {
      lineHeight: 1.15,
...
const KenteStripes = ({
  ...
  const stripes = [[TOKENS.indigo, 60], [TOKENS.gold, 16], [TOKENS.ink, 8], [TOKENS.gold, 16], [TOKENS.terracotta, 90], [TOKENS.cream, 12], [TOKENS.indigo, 36], [TOKENS.gold, 24], [TOKENS.ink, 10], [TOKENS.terracotta, 56], [TOKENS.indigo, 70], [TOKENS.gold, 18], [TOKENS.terracotta, 100], [TOKENS.indigo, 44], [TOKENS.gold, 16], [TOKENS.ink, 8], [TOKENS.terracotta, 60], [TOKENS.cream, 10], [TOKENS.indigo, 70], [TOKENS.gold, 22], [TOKENS.terracotta, 80], [TOKENS.ink, 10], [TOKENS.indigo, 50]];
  return /*#__PURE__*/React.createElement("div", {
    style: {
      width,
      height: "100%",
  ...
  }, stripes.map(([c, h], i) => /*#__PURE__*/React.createElement("div", {
    key: i,
    style: {
      background: c,
      height: h,
...
const KenteBar = ({
  ...
  const a = reverse ? "linear-gradient(90deg, #2C6B4F 0 33%, #FFC857 33% 66%, #C44536 66% 100%)" : "linear-gradient(90deg, #C44536 0 33%, #FFC857 33% 66%, #2C6B4F 66% 100%)";
  return /*#__PURE__*/React.createElement("div", {
    "aria-hidden": true,
    style: {
      height,
...
const SectionEyebrow = ({
  ...
  style: {
    ...
    textTransform: "uppercase",
    fontWeight: 700,
    color: dark ? TOKENS.starGold : color,
...
const SectionHeadline = ({
  ...
  const fontSize = size === "large" ? "clamp(40px, 6vw, 88px)" : "clamp(32px, 4.6vw, 64px)";
...
const Countdown = ({
  ...
  }, cells.map(([label, v], i) => /*#__PURE__*/React.createElement("div", {
    key: label,
    style: {
      padding: "14px 22px",
      minWidth: 88,
...
/* ───────────────────── Nav ───────────────────── */
const NAV_LINKS = [["About", "index.html#about"], ["Agenda", "agenda.html"], ["Speakers", "speakers.html"], ["Sponsors", "sponsors.html"], ["Volunteer", "volunteer.html"], ["FAQ", "index.html#faq"]];
const Nav = ({
  onRegister,
  onMobileToggle,
  mobileOpen,
...
const ADINKRA_MEANING = {
  ...
  gyenyame: {
    label: "Gye Nyame",
    meaning: "Except for God — the omnipotence of the divine"
  },
  dwennimmen: {
    label: "Dwennimmen",
  ...
  nkyinkyim: {
    label: "Nkyinkyim",
    meaning: "Twisting — adaptability and resolve on the journey"
  }
};
const Adinkra = ({
  name = "gyenyame",
  ...
  return /*#__PURE__*/React.createElement("svg", {
    ...
    height: size,
    role: "img",
    "aria-label": `${m.label} — ${m.meaning}`,
    style: {
      display: "block"
    }
  }, /*#__PURE__*/React.createElement("title", null, title || `${m.label} — ${m.meaning}`), /*#__PURE__*/React.createElement("path", {
    d: paths[name] || paths.gyenyame,
    fill: color
  }));
};
...
const AkwaabaWeave = ({
  ...
  const warp = tone === "light" ? "repeating-linear-gradient(90deg, #C44536 0 14px, transparent 14px 28px), repeating-linear-gradient(90deg, transparent 0 28px, #E8B23A 28px 34px), repeating-linear-gradient(0deg, #1B3A6B 0 10px, transparent 10px 30px)" : "repeating-linear-gradient(90deg, rgba(255,200,87,0.5) 0 14px, transparent 14px 28px), repeating-linear-gradient(0deg, rgba(196,69,54,0.5) 0 10px, transparent 10px 30px)";
  return /*#__PURE__*/React.createElement("div", {
    "aria-hidden": true,
    style: {
      position: "absolute",
...
}, glyph && /*#__PURE__*/React.createElement(Adinkra, {
  name: glyph,
  size: 26,
...
}, "A community-led conference for cloud builders in Ghana, organised by AWS User Group Accra. Independent, free, and run by volunteers."), /*#__PURE__*/React.createElement("div", {
  style: {
    marginTop: 20,
    display: "flex",
    alignItems: "center",
...
}, "Organised by"), /*#__PURE__*/React.createElement("img", {
...
}, "Code of conduct."), " We're committed to a harassment-free, inclusive event for everyone. Harassment of any kind will not be tolerated. The full policy follows the AWS Community Day code of conduct \u2014 read it before you attend."), /*#__PURE__*/React.createElement("div", {
  style: {
    fontSize: 11,
    opacity: 0.5
  }
}, "\xA9 2026 AWS Community Day Ghana \xB7 Made in Accra"))));
...
const NotifyModal = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "Get notified"), /*#__PURE__*/React.createElement("h3", {
    style: {
      fontFamily: "'Inter', sans-serif",
      fontSize: 30,
      fontWeight: 800,
  ...
  }, "Stay in", /*#__PURE__*/React.createElement("br", null), "the loop."), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 15,
      color: TOKENS.ink2,
      lineHeight: 1.55,
  ...
  }, "Registration is already open on Luma. Leave your email for speaker and agenda updates."), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      flexDirection: "column",
      gap: 12
    ...
    placeholder: "Role \xB7 e.g. Backend engineer (optional)",
    value: data.role,
    onChange: e => setData({
      ...data,
      role: e.target.value
    ...
    onClick: () => data.name && data.email.includes("@") && setStep(1),
    disabled: !data.name || !data.email.includes("@"),
    style: {
      ...btnPrimary(),
      width: "100%",
      marginTop: 20,
      opacity: !data.name || !data.email.includes("@") ? 0.4 : 1,
      cursor: !data.name || !data.email.includes("@") ? "not-allowed" : "pointer"
    }
    ...
    style: {
      ...
      height: 56,
      margin: "0 auto 20px",
      background: `conic-gradient(from 0deg, ${TOKENS.terracotta} 0 33%, ${TOKENS.starGold} 33% 66%, ${TOKENS.green} 66% 100%)`,
      borderRadius: 10,
      transform: "rotate(45deg)"
    }
  ...
  }, "Medaase,", /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("span", {
    style: {
      color: TOKENS.terracotta
    }
  ...
  }, "You're on the list. We'll email ", /*#__PURE__*/React.createElement("strong", null, data.email), " with speaker and agenda updates."), /*#__PURE__*/React.createElement("button", {
    onClick: onClose,
    style: {
      ...btnGhost(),
      marginTop: 28
